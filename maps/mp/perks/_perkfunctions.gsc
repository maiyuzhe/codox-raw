...
setStalker()
{
	...
	for ( ;; )
	{
		if(self playerAds() == 1) 
		{
			if(getWeaponClass(self getCurrentWeapon()) == "weapon_smg" || getWeaponClass(self getCurrentWeapon()) == "weapon_pistol" || getWeaponClass(self getCurrentWeapon()) ==  "weapon_machine_pistol")
			{
			...
			{
				if(isSubStr(self getCurrentWeapon(), "spas12") || isSubStr(self getCurrentWeapon(), "model1887"))
				{
					self.moveSpeedScaler = 1.25;
					self maps\mp\gametypes\_weapons::updateMoveSpeedScale("primary");
				}
