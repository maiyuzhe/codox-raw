...
init()
{
	...
	// 	case "mp_killhouse_sh":
	// 	case "mp_nuked":
	// 	case "mp_storm_spring":
	// 	case "mp_underpass":
	// 		iPrintLn("CODOL MAP");
	game["music"]["spawn_allies"] = maps\mp\gametypes\_teams::getTeamVoicePrefix( "allies" ) + "spawn_music_" + getDvar("mapname");
	...
	game["music"]["winning_allies"] = maps\mp\gametypes\_teams::getTeamVoicePrefix( "allies" ) + "winning_music_" + getDvar("mapname");
	game["music"]["losing_allies"] = maps\mp\gametypes\_teams::getTeamVoicePrefix( "allies" ) + "losing_music_" + getDvar("mapname");
	game["voice"]["allies"] = maps\mp\gametypes\_teams::getTeamVoicePrefix( "allies" ) + "1mc_";

	game["music"]["spawn_axis"] = maps\mp\gametypes\_teams::getTeamVoicePrefix( "axis" ) + "spawn_music_" + getDvar("mapname");
	...
	game["music"]["winning_axis"] = maps\mp\gametypes\_teams::getTeamVoicePrefix( "axis" ) + "winning_music_" + getDvar("mapname");
	game["music"]["losing_axis"] = maps\mp\gametypes\_teams::getTeamVoicePrefix( "axis" ) + "losing_music_" +getDvar("mapname");
	...
	game["music"]["suspense"] = "mp_suspense_" + getDvar("mapname");
	// 	default:
	// 		iPrintLn("Non-Codol Map");
...
suspenseMusic()
{
	...
	for ( ;; )
	{
		...
		playSoundOnPlayers ( game["music"]["suspense"] );
	}
}
